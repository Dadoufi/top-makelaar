...
class ProgressTimeLatch(
    private val delayMs: Long = LOADING_DISMISS_DELAY,
    private val minShowTime: Long = LOADING_MIN_SHOW_TIME,
    ...
    companion object {
        const val LOADING_MIN_SHOW_TIME = 1350L
        const val LOADING_DISMISS_DELAY = 750L
    }
}